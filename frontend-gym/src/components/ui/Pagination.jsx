...
const Pagination = ({
  ...
  if (totalPages <= 1) {
    return (
      <div className={`flex items-center justify-between px-6 py-3 bg-white border-t border-slate-200 ${className}`}>
    ...
    <div className={`flex items-center justify-between px-6 py-4 bg-white border-t border-slate-200 ${className}`}>
      ...
      <div className="flex items-center space-x-4">
        <div className="text-sm text-slate-500">
          ...
          <span className="font-medium text-indigo-600">{totalItems}</span> registros
        </div>
        <div className="text-xs text-slate-400">
      ...
      <div className="flex items-center space-x-2">
        ...
        <button
          ...
          className="inline-flex items-center px-3 py-2 text-sm font-medium text-slate-600 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 hover:text-indigo-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
        >
